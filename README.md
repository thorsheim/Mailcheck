...
| RPKI | — | ROA validation + ASPA per NS/MX host IP via RIPE Stat |
| Security.txt | RFC 9116 | Required/optional fields, expiry |
| WHOIS | RFC 7480 | RDAP lookup via rdap.org |
| Recommendations | — | Prioritised action list with weights |
...
PTR, BIMI, RPKI, Security.txt, and WHOIS are informational — shown but not scored.
